                ...
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-6 d-flex align-items-center">
                            <h6 class="mb-0">Edit Menu Makanan</h6>
                        </div>
                    ...
                    <form action="{{ route('admin.foods.update', $food->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" id="name" name="name" value="{{ old('name', $food->name) }}" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('price') is-invalid @enderror" type="number" id="price" name="price" value="{{ old('price', $food->price) }}" min="0" required>
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if($food->image)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $food->image) }}" alt="{{ $food->name }}" class="img-thumbnail" id="current-image" style="max-height: 150px; max-width: 100%; object-fit: contain;">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('nutrition_facts') is-invalid @enderror" id="nutrition_facts" name="nutrition_facts" rows="3" required>{{ old('nutrition_facts', $food->nutrition_facts) }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $food->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-end">
                                <button type="submit" class="btn btn-primary mb-0">Update Makanan</button>
                            </div>
                        </div>
                    </form>
                </div>
